...
| `ADDR_RANGE_*` | VERIFIED / constrained | Range matrix covers omitted widths 0–3 including base-0 full 4 GiB. Invalid non-power-of-two and misaligned ranges, plus a zero-tag geometry, are rejected at generation time. |
