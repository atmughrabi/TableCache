...
| 38 | configuration guards | Wrapper/cache/shim allowed incompatible widths, ID relations, line counts, bank/cascade geometry, and zero-tag capacity. | Generation-time fatal guards plus zero-width-safe one-line-per-bank address generation. | ID/depth matrix 18 cells; geometry matrix 41 cells; l2_top matrix 18 cells; invalid configs reject deterministically. |
